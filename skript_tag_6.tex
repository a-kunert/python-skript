...
\begin{enumerate}[<+->]
	\item Datei öffnen 
	\item Datei bearbeiten (d.h. z.B. lesen, überschreiben, etwas anhängen)
	\item Datei schließen
\end{enumerate}
...
\vspace{2pt}
\begin{itemize}[<+->]
\item Die Methode \py{.readlines()} gibt eine \emph{Liste} der Zeilen des Inhalts der Datei \pybw{"some_file.txt"} zurück. 
